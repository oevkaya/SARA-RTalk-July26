...
- To meet you and keep in touch

- Challenging myself with another talk

- being a part of big R community across the world

[About me](https://oevkaya.netlify.app/home)
...
- Data Representation: The form in which data is stored and communicated, might differ in various ways (visualization, physicalization).

## Data Visualization

- As a part of the general data representation, data visualization is very important ingredient of any data analysis workflow. 
...
- For the abstraction, sketching your ideas on a paper or screen is a kind of start all the time. Or maybe in today's computer-based era, inspiring from available examples. 
...
- Start simple: summaries + visuals with EDA mindset. Always iterate to get a better version
...
**However**, more is not necessarily good - there should be certain design choices and solid level of data understanding to decide what and how to visualize
...
* In general, there are various resources to explore in R ecosystem. 
...
## From my student projects - 25-26

```{r, out.width='60%', fig.align='center', out.height='50%'}
knitr::include_graphics(c("lothian_kmeans_raw_map.png"))
```

UG project: Exploiting clustering with vine copulas to examie the Scottish Index of Multiple Deprivation (SIMD) 2020

## From my student projects - 25-26

```{r, out.width='60%', fig.align='center'}
knitr::include_graphics(c("ch5_scnC_price_boxplot.png"))
```

UG project: Visualizing Edinburgh’s Fringe for festivalgoers: Shiny web application study

## From a joint work- Map challenge

```{r, out.width='60%', fig.align='center', out.height='50%'}
knitr::include_graphics(c("Nd142_Peninsula_Bubbles_both.png"))
```

Research paper: Working with small sample data for Antarctic region
...
## LLMs are everyhwhere

- More AI support in R or python nowadays, including specific packages to use LLMs within IDE

- Code generation is being easier - Github Copilot

- Specific package AI helper, such as Shiny Assistant or others


## How to train ourselves? 

- More AI empowered data viz coming (creating by speaking), but the design and interpretation should require active human-being involvements

- Easier to create web-based platforms like shiny and its flexibilities allow users to interact with data more, when it is really useful

- To explore/reproduce and examine different data viz examples via open sources, critique them is the key for expanding our knowledge

- Following specific up-to-date websites or pioneering people in the field such as [Cara Thompson](https://www.cararthompson.com/), [Nicola Rennie](https://nrennie.rbind.io/)

- Exercising and working together via specific platforms, R-based community events, or data viz competitions or datathons are good sources of learning opportunities
...
- This talk and slides: **https://github.com/oevkaya/SARA-RTalk-July26**
