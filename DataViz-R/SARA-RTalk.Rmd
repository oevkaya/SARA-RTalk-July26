...
- More AI empowered data viz coming, but the design and interpretation should require active human-being involvements

- We are moving towards to data viz by describing, speaking directly with natural language
...
- To explore and examine different data viz examples, critique them is the key for expanding our knowledge

- Looking at open source materials and reproducing them is a good set of exercises

- Following specific up-to-date websites or pioneering people in the field such as [Cara Thompson](https://www.cararthompson.com/)
